...
wrSVmainS1 <- function(prefix) {
  glue::glue(
    ...
    '  ##############################\n',
    '  getGsc1s1inp1 <- reactive({\n',
    '    req(input$sc1s1ass1)\n',
    '    res <- names(sc1gene[[input$sc1s1ass1]])\n',
    '    resDef1 <- sc1def$gene1[[input$sc1s1ass1]]\n',
    '    return(list(res, resDef1))\n',
    '  })\n',
    '\n',
    '  observeEvent(input$sc1s1ass1, {\n',
    '    updateSelectizeInput(\n',
    '      session,\n',
    '      "sc1s1feat1",\n',
    '      choices = getGsc1s1inp1()[[1]],\n',
    '      server = TRUE,\n',
    '      selected = getGsc1s1inp1()[[2]],\n',
    '      options = list(\n',
    ...
    '  })\n',
    '  \n',
    '  output$sc1s1sub1.ui <- renderUI({\n',
    '    sub <- strsplit(sc1conf[UI == input$sc1s1sub1]$fID, "\\|")[[1]]\n',
    '    checkboxGroupInput("sc1s1sub2", "Select which cells to show",\n',
    '      inline = TRUE,\n',
    '      choices = sub, selected = sub\n',
    '    )\n',
    '  })\n',
    '  observeEvent(input$sc1s1sub1non, {\n',
    '    sub <- strsplit(sc1conf[UI == input$sc1s1sub1]$fID, "\\|")[[1]]\n',
    '    updateCheckboxGroupInput(session,\n',
    '      inputId = "sc1s1sub2", label = "Select which cells to show",\n',
    '      choices = sub, selected = NULL, inline = TRUE\n',
    '    )\n',
    '  })\n',
    '  observeEvent(input$sc1s1sub1all, {\n',
    '    sub <- strsplit(sc1conf[UI == input$sc1s1sub1]$fID, "\\|")[[1]]\n',
    '    updateCheckboxGroupInput(session,\n',
    '      inputId = "sc1s1sub2", label = "Select which cells to show",\n',
    '      choices = sub, selected = sub, inline = TRUE\n',
    ...
    '  })\n',
    '  \n',
    '  output$sc1s1oup1.ui <- renderUI({\n',
    '    plotOutput("sc1s1oup1", height = pList[input$sc1s1psz])\n',
    '  })\n',
    '  \n',
    '  output$sc1s1oup1.pdf <- downloadHandler(\n',
    '    filename = function() {\n',
    '      paste0(\n',
    '        "sc1", input$sc1s1drX, "_", input$sc1s1drY, "_",\n',
    '        input$sc1s1inp1, ".pdf"\n',
    '      )\n',
    '    },\n',
    '    content = function(file) {\n',
    '      ggsave(\n',
    '        file,\n',
    '        device = "pdf", height = input$sc1s1oup1.h, width = input$sc1s1oup1.w, useDingbats = FALSE,\n',
    '        plot = scDRcellsplit(\n',
    '          sc1conf,\n',
    '          sc1meta,\n',
    '          sc1def,\n',
    ...
    '    }\n',
    '  )\n',
    '  output$sc1s1oup1.png <- downloadHandler(\n',
    '    filename = function() {\n',
    '      paste0(\n',
    '        "sc1", input$sc1s1drX, "_", input$sc1s1drY, "_",\n',
    '        input$sc1s1inp1, ".png"\n',
    ...
    '    ggsave(\n',
    '      file,\n',
    '      device = "png", height = input$sc1s1oup1.h, width = input$sc1s1oup1.w,\n',
    '      plot = scDRcellsplit(\n',
    '        sc1conf,\n',
    '        sc1meta,\n',
    '        sc1def,\n',
