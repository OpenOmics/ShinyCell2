...
wrSVmainA1 <- function(prefix) {
  ...
  '                         server = TRUE, selected = getG{prefix}a1inp1()[[1]][1], options = list( \n',
    ...
    '    # The feature selectize is filled server-side, so input${prefix}a1inp1 is "" during\n',
    '    # the initial round-trip. Resolve to the same default the selectize will\n',
    '    # receive (first available choice) so the table always computes against a\n',
    '    # valid feature instead of racing on an empty value.\n',
    '    a1inp1 = input${prefix}a1inp1\n',
    '    if(is.null(a1inp1) || a1inp1 == ""){{ a1inp1 = getG{prefix}a1inp1()[[1]][1] }}\n',
    '    ggData = sc2Dnum({prefix}conf, {prefix}meta, {prefix}dimr, input${prefix}a1dr, {prefix}a1oup1xy$x, {prefix}a1oup1xy$y, a1inp1,\n',
...
wrSVmainA2 <- function(prefix) {
  glue::glue(
    ...
    '    # Both feature selectizes are filled server-side (choices = NULL in the UI),\n',
    '    # so they are "" during the initial round-trip. Resolve to the same defaults\n',
    '    # they will receive so the table computes against valid features rather than\n',
    '    # racing on empty values.\n',
    '    a2inp1 = input${prefix}a2inp1; a2inp2 = input${prefix}a2inp2\n',
    '    if(is.null(a2inp1) || a2inp1 == ""){{ a2inp1 = getG{prefix}a2inp1()[[2]] }}\n',
    '    if(is.null(a2inp2) || a2inp2 == ""){{ a2inp2 = getG{prefix}a2inp2()[[2]] }}\n',
    '    ggData = sc2Dcnum({prefix}conf, {prefix}meta, a2inp1, a2inp2,\n',
    '                      "{prefix}assay_", {prefix}gene, input${prefix}a2ass1, input${prefix}a2ass2, input${prefix}a2sub1, input${prefix}a2sub2,\n',
    '                      input${prefix}a2min1, input${prefix}a2max1, input${prefix}a2min2, input${prefix}a2max2)\n',
    '    datatable(ggData, rownames = FALSE, extensions = "Buttons",\n',
    '              options = list(pageLength = -1, dom = "tB", buttons = c("copy", "csv", "excel")))\n',
...
wrSVmainA3 <- function(prefix) {
  glue::glue(
    ...
    '    # they will receive so the table computes against valid features rather than\n',
    '    # racing on empty values.\n',
    '    a3inp1 = input${prefix}a3inp1; a3inp2 = input${prefix}a3inp2\n',
    '    if(is.null(a3inp1) || a3inp1 == ""){{ a3inp1 = getG{prefix}a3inp1()[[2]] }}\n',
    '    if(is.null(a3inp2) || a3inp2 == ""){{ a3inp2 = getG{prefix}a3inp1()[[3]] }}\n',
    '    ggData = scDRcoexNum({prefix}conf, {prefix}meta, a3inp1, a3inp2, \n',
    '                         paste0("{prefix}assay_", input${prefix}a3ass1, ".h5"), {prefix}gene[[input${prefix}a3ass1]], \n',
