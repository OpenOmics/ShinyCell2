...
wrSVmainS1 <- function(prefix) {
  glue::glue(
    '  ##############################\n',
    '  # s1 tab dynamic html events #\n',
    '  ##############################\n',
    '  getG{prefix}s1inp1 <- reactive({\n',
    '    req(input${prefix}s1ass1)\n',
    '    res <- names({prefix}gene[[input${prefix}s1ass1]])\n',
    '    resDef1 <- {prefix}def$gene1[[input${prefix}s1ass1]]\n',
    '    return(list(res, resDef1))\n',
    '  })\n',
    '\n',
    '  observeEvent(input${prefix}s1ass1, {\n',
    '    updateSelectizeInput(\n',
    '      session,\n',
    '      "{prefix}s1feat1",\n',
    '      choices = getG{prefix}s1inp1()[[1]],\n',
    '      server = TRUE,\n',
    '      selected = getG{prefix}s1inp1()[[2]],\n',
    '      options = list(\n',
    ...
    '    checkboxGroupInput("{prefix}s1sub2", "Select which cells to show",\n',
    '      inline = TRUE,\n',
    '      choices = sub, selected = sub\n',
    '    )\n',
    '  })\n',
    ...
    '      inputId = "{prefix}s1sub2", label = "Select which cells to show",\n',
    '      choices = sub, selected = NULL, inline = TRUE\n',
    '    )\n',
    '  })\n',
    ...
    '      {prefix}dimr,\n',
    '      {prefix}gene,\n',
    '      paste0("{prefix}assay_", input${prefix}s1ass1, ".h5"),\n',
    '      input${prefix}s1ass1,\n',
    '      input${prefix}s1dr,\n',
    '      input${prefix}s1feat1,\n',
    '      input${prefix}s1inp3,\n',
    '      input${prefix}s1txt,\n',
    '      input${prefix}s1fsz,\n',
    '      input${prefix}s1siz,\n',
    ...
    '  })\n',
    '  \n',
    '  output${prefix}s1oup1.ui <- renderUI({\n',
    '    plotOutput("{prefix}s1oup1", height = pList[input${prefix}s1psz])\n',
    '  })\n',
    '  \n',
    '  output${prefix}s1oup1.pdf <- downloadHandler(\n',
    '    filename = function() {\n',
    '      paste0(\n',
    '        "{prefix}", input${prefix}s1drX, "_", input${prefix}s1drY, "_",\n',
    '        input${prefix}s1inp1, ".pdf"\n',
    '      )\n',
    '    },\n',
    '    content = function(file) {\n',
    '      ggsave(\n',
    '        file,\n',
    '        device = "pdf", height = input${prefix}s1oup1.h, width = input${prefix}s1oup1.w, useDingbats = FALSE,\n',
    '        plot = scDRcellsplit(\n',
    '          {prefix}conf,\n',
    '          {prefix}meta,\n',
    '          {prefix}def,\n',
    ...
    '    }\n',
    '  )\n',
    '  output${prefix}s1oup1.png <- downloadHandler(\n',
    '    filename = function() {\n',
    '      paste0(\n',
    '        "{prefix}", input${prefix}s1drX, "_", input${prefix}s1drY, "_",\n',
    '        input${prefix}s1inp1, ".png"\n',
    '      )\n',
    '    },\n',
    '    content = function(file) {\n',
    '    ggsave(\n',
    '      file,\n',
    '      device = "png", height = input${prefix}s1oup1.h, width = input${prefix}s1oup1.w,\n',
    '      plot = scDRcellsplit(\n',
    '        {prefix}conf,\n',
    '        {prefix}meta,\n',
    '        {prefix}def,\n',
