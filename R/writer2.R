...
wrUImainA2 <- function(prefix, ptsiz) {
  glue::glue(
    ...
    '    # Assay selection\n',
    '    fluidRow(\n',
    '      column(3, selectInput("{prefix}s1ass1", "Assay:",\n',
    ...
    '        3, fluidRow(\n',
    '          column(\n',
    '            12, selectInput("{prefix}s1dr", "Reduction:",\n',
    ...
    '        # Split by selection\n',
    '        selectInput("{prefix}s1inp3", "Split by",\n',
    '          choices = {prefix}conf[grp == TRUE]$UI,\n',
    '          selected = {prefix}def$grp1\n',
    '        ) % %\n',
    '          helper(\n',
    ...
    '        ),\n',
    '        br(), br(),\n',
    '        actionButton("{prefix}s1tog2", "Toggle graphics controls"),\n',
    '        conditionalPanel(\n',
    '          condition = "input.{prefix}s1tog2 % 2 == 1",\n',
    '          sliderInput("{prefix}s1siz", "Point size:",\n',
    ...
    '            selected = "Large", inline = TRUE\n',
    '          ),\n',
    '          radioButtons("{prefix}s1asp", "Aspect ratio:",\n',
    '            choices = c("Square", "Fixed", "Free"),\n',
    '            selected = "Free", inline = TRUE\n',
    '          ),\n',
    '          checkboxInput("{prefix}s1txt", "Show axis text", value = FALSE)\n',
    '        ),\n',
    '        br(), br(),\n',
    '        actionButton("{prefix}s1tog3", "Toggle plot controls"),\n',
    '        conditionalPanel(\n',
    '          condition = "input.{prefix}s1tog3 % 2 == 1",\n',
    '          radioButtons("{prefix}s1col1", "Colour (Continuous data):",\n',
    '            choices = c("White-Red", "Blue-Yellow-Red", "Yellow-Green-Purple"),\n',
    '            selected = "Blue-Yellow-Red"\n',
    '          ),\n',
    '          radioButtons("{prefix}s1ord1", "Plot order:",\n',
    '            choices = c("Max-1st", "Min-1st", "Original", "Random"),\n',
    '            selected = "Original", inline = TRUE\n',
    '          )\n',
    '        ),\n',
    '      ), # End of column (6 space)\n',
    '      column(\n',
    '        9, uiOutput("{prefix}s1oup1.ui"),\n',
    '        downloadButton("{prefix}s1oup1.pdf", "Download PDF"),\n',
    '        downloadButton("{prefix}s1oup1.png", "Download PNG"), br(),\n',
    '        div(\n',
    '          style = "display:inline-block",\n',
    '          numericInput("{prefix}s1oup1.h", "PDF / PNG height:",\n',
    '            width = "138px",\n',
    '            min = 4, max = 20, value = 8, step = 0.5\n',
    '          )\n',
    '        ),\n',
    '        div(\n',
    '          style = "display:inline-block",\n',
    '          numericInput("{prefix}s1oup1.w", "PDF / PNG width:",\n',
    '            width = "138px",\n',
