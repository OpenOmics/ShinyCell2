...
wrUIload <- function(prefix) {
  glue::glue(
    ...
    '{prefix}conf$factor <- sapply({prefix}conf$UI, function(col_name) {\n',
    '\tis.factor({prefix}meta[[col_name]])\n',
    '})\n',
    '\n'
  )
}
...
wrUImainA2 <- function(prefix, ptsiz) {
  glue::glue(
    ...
    '    # Assay selection\n',
    '    fluidRow(\n',
    '      column(3, selectInput("sc1s1ass1", "Assay:",\n',
    ...
    '        3, fluidRow(\n',
    '          column(\n',
    '            12, selectInput("sc1s1dr", "Reduction:",\n',
    ...
    '        # Split by selection\n',
    '        selectInput("sc1s1inp3", "Split by",\n',
    ...
    '          "sc1s1feat1",\n',
    '          "Gene/feature:",\n',
    '          choices = sc1def$genes[[sc1def$assay[1]]],\n',
    '          selected = sc1def$genes[[sc1def$assay[1]]][[1]],\n',
    '          options = list(\n',
    '            maxOptions = 7,\n',
    '            create = FALSE,\n',
    '            persist = TRUE\n',
    ...
    '        fluidRow(\n',
    '          column(\n',
    '            3, actionButton("sc1s1togL", "Toggle to subset cells"),\n',
    '            conditionalPanel(\n',
    '              condition = "input.sc1s1togL % 2 == 1",\n',
    '              selectInput("sc1s1sub1", "Cell information to subset:",\n',
    '                choices = sc1conf[grp == TRUE]$UI,\n',
    '                selected = sc1def$grp1\n',
    '              ),\n',
    '              uiOutput("sc1s1sub1.ui"),\n',
    '              actionButton("sc1s1sub1all", "Select all groups", class = "btn btn-primary"),\n',
    '              actionButton("sc1s1sub1non", "Deselect all groups", class = "btn btn-primary")\n',
    '            )\n',
    '          ), # End of column (6 space)\n',
    '        ),\n',
    '        br(), br(),\n',
    '        actionButton("sc1s1tog2", "Toggle graphics controls"),\n',
    '        conditionalPanel(\n',
    '          condition = "input.sc1s1tog2 % 2 == 1",\n',
    '          sliderInput("sc1s1siz", "Point size:",\n',
    '            min = 1, max = 4, value = 1.25, step = 0.25\n',
    '          ),\n',
    '          radioButtons("sc1s1psz", "Plot size:",\n',
    '            choices = c("Small", "Medium", "Large"),\n',
    '            selected = "Large", inline = TRUE\n',
    '          ),\n',
    '          radioButtons("sc1s1fsz", "Font size:",\n',
    '            choices = c("Small", "Medium", "Large"),\n',
    '            selected = "Large", inline = TRUE\n',
    '          ),\n',
    '          radioButtons("sc1s1asp", "Aspect ratio:",\n',
    '            choices = c("Square", "Fixed", "Free"),\n',
    '            selected = "Free", inline = TRUE\n',
    '          ),\n',
    '          checkboxInput("sc1s1txt", "Show axis text", value = FALSE)\n',
    '        ),\n',
    '        br(), br(),\n',
    '        actionButton("sc1s1tog3", "Toggle plot controls"),\n',
    '        conditionalPanel(\n',
    '          condition = "input.sc1s1tog3 % 2 == 1",\n',
    '          radioButtons("sc1s1col1", "Colour (Continuous data):",\n',
    '            choices = c("White-Red", "Blue-Yellow-Red", "Yellow-Green-Purple"),\n',
    '            selected = "Blue-Yellow-Red"\n',
    '          ),\n',
    '          radioButtons("sc1s1ord1", "Plot order:",\n',
    '            choices = c("Max-1st", "Min-1st", "Original", "Random"),\n',
    '            selected = "Original", inline = TRUE\n',
    '          )\n',
    '        ),\n',
    '      ), # End of column (6 space)\n',
    '      column(\n',
    '        9, uiOutput("sc1s1oup1.ui"),\n',
    '        downloadButton("sc1s1oup1.pdf", "Download PDF"),\n',
    '        downloadButton("sc1s1oup1.png", "Download PNG"), br(),\n',
    '        div(\n',
    '          style = "display:inline-block",\n',
    '          numericInput("sc1s1oup1.h", "PDF / PNG height:",\n',
    '            width = "138px",\n',
    '            min = 4, max = 20, value = 8, step = 0.5\n',
    '          )\n',
    '        ),\n',
    '        div(\n',
    '          style = "display:inline-block",\n',
    '          numericInput("sc1s1oup1.w", "PDF / PNG width:",\n',
    '            width = "138px",\n',
